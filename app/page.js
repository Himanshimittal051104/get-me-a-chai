    ...
    <div className="text-white text-center">
      <div >
        <div className=" flex justify-center pt-10 text-3xl font-bold mb-3">
          Get Me a Chai
          <Image src="./tea.svg" alt="tea"  width={40} height={40} className="mx-3 h-10" />
        </div>
      ...
      <div>
        ...
        <div className="flex justify-evenly mt-5 text-center">
          <div >
            <div className="w-12 h-12 rounded-full bg-slate-400 justify-center my-5 overflow-hidden mx-auto"> <Image src="./fans.svg" alt="fans" width={48} height={48}  className="h-12" /></div>
            <div>Fans want to help</div>
            <div>Fans are available to support you</div>
          </div>
          <div className="justify-center">
            <div className="w-12 h-12 rounded-full bg-slate-400 justify-center my-5 mx-auto"> <Image src="./coins.svg" alt="coins" width={48} height={48}/></div>
            <div>Fans want to contribute</div>
            <div>Fans are available to support you</div>
          </div>
          <div>
            <div className="w-12 h-12 rounded-full bg-slate-400 justify-center  my-5 overflow-hidden mx-auto"><Image src="./collaboration.svg" alt="collaboration" width={48} height={48}/> </div>

    ...
    <>
      <nav className='flex items-center bg-slate-950 text-white justify-between h-12 sticky top-0'>
        <div className='font-bold mx-2 p-2 flex gap-2 my-auto items-center'>
          <Image src="chai.svg" alt="chai" width={24} height={24}></Image>
          Get ME a Chai
        </div>
        <div className='flex relative'>
          ...
          {InputValue == '' ? (<Image src="search.svg" alt="search" width={24} height={24}  className='absolute left-48 top-1'></Image>) : (<Image src="cancel.svg" width={24} height={24} className='absolute left-48 top-1' alt="cancel"  onClick={handlekeyCancel} ></Image>)}
          {session ? (
